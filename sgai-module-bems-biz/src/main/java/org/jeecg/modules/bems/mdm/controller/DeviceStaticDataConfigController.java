...
public class DeviceStaticDataConfigController {
    ...
    //@RequiresPermission("bems:deviceStaticDataConfig:add")
    @PostMapping("/add")
    ...
    //@RequiresPermission("bems:deviceStaticDataConfig:delete")
    ...
    //@RequiresPermission("bems:deviceStaticDataConfig:edit")
    @PutMapping("/edit")
