...
public class EnergyAnalysisBenchmarkController {
    ...
    //@RequiresPermission("bems:energyAnalysisBenchmark:add")
    @PostMapping("/add")
    ...
    //@RequiresPermission("bems:energyAnalysisBenchmark:update")
    @PostMapping("/update")
    ...
    //@RequiresPermission("bems:energyAnalysisBenchmark:delete")
