...
//                    model.setDisableCheckbox(!hasDirectPermission);  // 取反：无权限时禁用
    ...
    public List<MeteringPoint> getElectricitySecondaryNodeForSpace() {
        return getSecondaryNode(MeteringPointConstant.TOPOLOGY_SPACE, DeviceConstant.ELECTRICITY_METER);
    }
    ...
    public List<MeteringPoint> getElectricitySecondaryNodeForRun() {
        return getSecondaryNode(MeteringPointConstant.TOPOLOGY_SPACE , DeviceConstant.ELECTRICITY_METER);//取电表的设备
//        return getSecondaryNode(MeteringPointConstant.TOPOLOGY_RUN , DeviceConstant.ELECTRICITY_METER);
    }
