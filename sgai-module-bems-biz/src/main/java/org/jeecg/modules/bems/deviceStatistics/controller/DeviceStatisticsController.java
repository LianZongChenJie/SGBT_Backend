...
public class DeviceStatisticsController {
    ...
    public Result<DeviceStatisticsVo> statistics(@RequestParam(required = false) String categoryId) {
        return Result.ok(deviceStatisticsService.statistics(categoryId));
    }
}
